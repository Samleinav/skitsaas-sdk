export const EVENT_HOOKS = {
    ...
    dashboardSubscriptionsOrganizationCancelRequested: 'dashboard.subscriptions.organization.cancel_requested',
    dashboardSubscriptionsOrganizationCanceled: 'dashboard.subscriptions.organization.canceled',
    dashboardSubscriptionsUserCancelRequested: 'dashboard.subscriptions.user.cancel_requested',
    ...
    adminSubscriptionTemplatePricingChanged: 'admin.subscriptions.template.pricing_changed',
    adminSubscriptionsActiveUpdateRequested: 'admin.subscriptions.active_update_requested',
    adminSubscriptionsOrganizationUpdated: 'admin.subscriptions.organization.updated',
    adminSubscriptionsOrganizationCleared: 'admin.subscriptions.organization.cleared',
